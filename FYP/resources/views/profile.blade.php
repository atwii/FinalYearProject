        ...
        <div class="quixnav">
            <div class="quixnav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li class="nav-label"><a href="/tiles">Tiles</a></li>
                   

                    <li class="nav-label"><a href="/sanitaryWare">Sanitaryware</a></li>

                    <li class="nav-label"><a href="/listServices">Services</a></li>

                    <li class="nav-label"><a href="/orders">Orders</a></li>
                    ...
                    <li><a class="has-arrow" href="javascript:void()" aria-expanded="false"><i
                        class="icon icon-single-04"></i><span class="nav-text">Features</span></a>
                <ul aria-expanded="false">
