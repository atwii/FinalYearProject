...
-->
    ...
    <div class="login-box" style="padding-top: 20%">
        <h2>New Service</h2>
        <form id="myForm" action="{{route('postService')}}" method="POST" enctype="multipart/form-data">
          ...
          <div class="user-box">
            <input type="checkbox" name="type" required="" value="Teblyt" >
            <label id="type2_label">Teblyt</label>
          </div>
          <div class="user-box">
            <input id="desc1" type="text" name="description1" required="">
            <label id="desc1_label">Description</label>
            <textarea name="description2" id="" cols="40" rows="4"></textarea>
          </div>
          <div class="user-box">
          ...
          <div class="user-box">
            <input type="file" style='margin: 0;
            padding: 2rem 1.5rem;
            font: 1rem/1.5 "PT Sans", Arial, sans-serif;
            color: #5a5a5a;' name="filenames[]" multiple="multiple" placeholder="image">
            <label>images</label>
          </div>
...
function assignUser(user) {
  ...
  document.getElementById("userId").value=user.id;
        ...
        function submitForm() {
          ...
          if(isChecked==true && description.value.length > 0 && address.value.length > 0){
            document.getElementById("myForm").submit();
          }
            else{
              if(isChecked==false){

                document.getElementById("type1_label").style.color="red";
                document.getElementById("type2_label").style.color="red";


              }
              if(description.value.length==0){

                document.getElementById("desc1_label").style.color="red";
