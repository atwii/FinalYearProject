...
<head>
    ...
    <title>Warshatok - Update Tiles</title>
    <!-- Favicon icon -->
...
<script>
    ...
    $(document).ready(function () {
        ...
        function displayUsers(users) {
            ...
            $('#user-name').val(users.tiles.name);
            $('#user-origin').val(users.tiles.origin);
            $('#user-retail-price').val(users.tiles.price_retail);
            $('#user-quantity').val(users.tiles.quantity);
            $('#user-packing').val(users.tiles.packing);
            $('#user-size').val(users.tiles.size);
            $('#user-description').val(users.tiles.description);
            var imageUrl = '{{ asset('storage') }}/' + users.tiles.picture;
  ...
  formData.append('packing', $('#user-packing').val());
...
// const formData = {
//             name: $('#user-name').val(),
//             origin: $('#user-origin').val(),
//             price_retail: $('#user-retail-price').val(),
//             quantity: $('#user-quantity').val(),
//             packing: $('#user-packing').val(),
//             size: $('#user-size').val(),
//             description: $('#user-description').val(),
//             picture: $('#user-file')[0].files[0]
//         };
        ...
        $.ajax({
            ...
            data: formData,
                ...
                processData: false,
            success: function (data) {
                     window.location.href = "/tilesAdmin";
            },
            error: function (error) {
