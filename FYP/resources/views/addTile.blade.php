...
<head>
    ...
    <title>Warshatok - Add Tile</title>
    <!-- Favicon icon -->
                                ...
                                <div class="basic-form">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <img src="#" id="user-image" alt="Selected Image" class="user-image" style="display:none">
                                            </div>
...
<script>
  ...
  formData.append('price_wholesale',$('#user-retail-price').val());
